<html>
		...
		<?php
          ...
          ?>
				<h1>Add Workshop</h1>
				<form action='../displays/addw.php' method='post'>
						Workshop Name: <input type="text" name="wname" /><p></p>
						Conducted By: 
						...
						Organiser Name: <input type="text" name="organiser_name" /><p></p>
						Entry Fee: <input type="text" name="fee" />
						<p></p>
						Day:
						<select name="day">
